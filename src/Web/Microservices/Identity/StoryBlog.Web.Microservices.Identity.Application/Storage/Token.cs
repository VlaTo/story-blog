...
public class Token
{
    ...
    /// </summary>
    public ICollection<string> AllowedSigningAlgorithms
    {
        get;
        set;
    }
    ...
    public string? SessionId
    {
        ...
        {
            return Claims
                .Where(x => x.Type == JwtClaimTypes.SessionId)
                .Select(x => x.Value)
                .SingleOrDefault();
        }
    }
    ...
    {
        Type = tokenType;
        AllowedSigningAlgorithms = new HashSet<string>();
        Audiences = new HashSet<string>();
