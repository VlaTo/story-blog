...
public static class ValidatedAuthorizeRequestExtensions
{
    ...
    {
        request.AuthenticationContextReferenceClasses.RemoveAll(
            acr => acr.StartsWith(prefix, StringComparison.Ordinal)
        );
    ...
    public static void RemovePrompt(this ValidatedAuthorizeRequest request)
    {
        ...
        request.Raw.Add(IdentityServerConstants.SuppressedPrompt, suppress.ToString());
