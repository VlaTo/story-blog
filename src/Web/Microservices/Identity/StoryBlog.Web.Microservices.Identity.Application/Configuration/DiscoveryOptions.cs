...
public class DiscoveryOptions
{
    ...
    /// </summary>
    public bool ShowIdentityScopes
    {
        get;
        set;
    }
    ...
    /// </summary>
    public bool ShowExtensionGrantTypes
    {
        get;
        set;
    }
    ...
    /// </summary>
    public bool ShowTokenEndpointAuthenticationMethods
    {
        get;
        set;
    }
    ...
    /// </summary>
    public bool ExpandRelativePathsInCustomEntries
    {
        get;
        set;
    }
    ...
    /// </value>
    public int? ResponseCacheInterval
    {
        get;
        set;
    }
    ...
    /// </summary>
    public Dictionary<string, object> CustomEntries
    {
        get;
        set;
    }
