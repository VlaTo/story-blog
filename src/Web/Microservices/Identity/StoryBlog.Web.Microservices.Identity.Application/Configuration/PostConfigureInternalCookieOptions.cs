...
internal sealed class PostConfigureInternalCookieOptions : IPostConfigureOptions<CookieAuthenticationOptions>
{
        ...
        ILoggerFactory loggerFactory)
    {
        ...
        logger = loggerFactory.CreateLogger("StoryBlog.IdentityServer.Startup");
    }
