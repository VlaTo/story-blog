...
public class ValidatedAuthorizeRequest : ValidatedRequest
{
    ...
    /// </summary>
    public IEnumerable<string> RequestedResourceIndiators
    {
        get;
        set;
    }
    ...
    /// </value>
    public bool IsApiResourceRequest
    {
        get;
        set;
    }
    ...
    /// </value>
    public List<string> AuthenticationContextReferenceClasses
    {
        get;
        set;
    }
    ...
    /// </value>
    public IEnumerable<string> PromptModes
    {
        get;
        set;
    ...
    /// </value>
    internal IEnumerable<string> OriginalPromptModes
    {
        get;
        set;
    } = Enumerable.Empty<string>();
    ...
    /// </value>
    internal IEnumerable<string> SuppressedPromptModes
    {
        get;
        set;
    } = Enumerable.Empty<string>();
